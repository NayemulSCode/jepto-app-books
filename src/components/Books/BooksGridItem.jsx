...
<div className='flex-grow flex flex-col justify-between gap-6 mt-4'>
        ...
        <div className="flex items-center gap-3 text-xs lg:text-sm">
          <button
            ...
            className={`flex min-w-[180px] w-full items-center justify-center gap-1 rounded-md transition-all py-1.5 lg:py-2 ${favourite ? 'bg-[#DC2954]/[14%] text-[#DC2954] hover:bg-[#DC2954]/[24%]' : 'bg-[#1C4336]/[14%] text-[#1C4336] hover:bg-[#1C4336]/[24%]'}`}
          >
            {favourite ? (
              <>
